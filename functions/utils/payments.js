...
export class StripeProcessor {
  ...
  async processPayment(paymentData) {
    try {
      const { amount, currency = 'SAR', cardData, orderId, customerEmail } = paymentData;
...
export class PayPalProcessor {
  ...
  async processPayment(paymentData) {
    try {
      const { amount, currency = 'SAR', orderId, returnUrl, cancelUrl } = paymentData;
...
export class PaymentProcessor {
  ...
  async processPayment(paymentData) {
    ...
    try {
      ...
      console.log(`Processing ${method} payment for order ${paymentData.orderId}`);
